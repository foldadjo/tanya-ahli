          ...
          <div className="mt-8 md:mt-12 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8 transform transition-all duration-300 hover:shadow-xl">
            ...
            <div className="prose prose-lg max-w-none prose-blue dark:prose-invert">
              <ReactMarkdown 
                ...
                components={{
                  h1: ({node, ...props}) => <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3 md:mb-4" {...props} />,
                  h2: ({node, ...props}) => <h2 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2 md:mb-3" {...props} />,
                  h3: ({node, ...props}) => <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-200 mb-2" {...props} />,
                  p: ({node, ...props}) => <p className="text-gray-700 dark:text-gray-300 mb-3 md:mb-4 leading-relaxed" {...props} />,
                  ul: ({node, ...props}) => <ul className="list-disc list-inside mb-3 md:mb-4 space-y-1 md:space-y-2" {...props} />,
                  ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-3 md:mb-4 space-y-1 md:space-y-2" {...props} />,
                  ...
                  pre: ({node, ...props}) => (
                    <pre className="bg-gray-100 dark:bg-gray-700 text-black dark:text-white rounded p-3 md:p-4 text-sm font-mono my-3 md:my-4 overflow-x-auto" {...props} />
                  ),
                  a: ({node, ...props}) => (
